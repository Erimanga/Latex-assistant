 ...
 * Just a raw completion source — no wrapping, no override. Safe.
 */
...
/**
 * A raw CodeMirror completion source function.
 * Registered directly as an Extension — merges with Obsidian's completions.
 */
export function snippetCompletionSource(settings: LatexAssistantSettings) {
